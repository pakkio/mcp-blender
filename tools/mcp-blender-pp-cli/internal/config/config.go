...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("MCP_BLENDER_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("MCP_BLENDER_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "mcp-blender-pp-cli", "config.json"), nil
}
