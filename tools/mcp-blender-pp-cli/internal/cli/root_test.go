...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"assets import-online",
		"assets search-online",
		"camera-lighting",
		"camera-lighting camera-setup",
		"camera-lighting compositor-effects",
		"camera-lighting evaluate-scene",
		"camera-lighting frame-objects",
		"camera-lighting light-setup",
		"camera-lighting look-at",
		"camera-lighting screenshot",
		"camera-lighting studio-lighting",
		"camera-lighting sun-sky-rig",
		"docs",
		"evaluate-scene-visually",
		"import-online-asset",
		"material",
		"material assign",
		"material create",
		...
		"mesh origin-cursor",
		"mesh remesh",
		"mesh simplify-geometry",
		"mesh transform",
		"mesh uv-unwrap",
		"physics-sim",
		"physics-sim add-force-field",
		"physics-sim bake-fluid",
		"physics-sim configure-physics",
		"physics-sim setup-cloth",
		"physics-sim setup-rigid-body",
		"python-exec",
		"render-pipeline",
		"render-pipeline bake-textures",
		"render-pipeline export-unity-fbx",
		"render-pipeline generate-lods",
		"render-pipeline render-anim",
		"render-pipeline render-image",
		"render-pipeline vfx-shadow-catcher",
		"render-pipeline vfx-tracking",
		"rigging-anim",
		"rigging-anim apply-hair-groom",
		"rigging-anim create-armature",
		"rigging-anim create-hair-curves",
		"rigging-anim pose-bone",
		"rigging-anim set-keyframe",
		"rigging-anim setup-humanoid-rig",
		"rigging-anim setup-ik",
		"rigging-anim timeline-range",
		"rigging-anim turntable",
		"scene",
		"scene busy",
		"scene checkpoint-create",
		"scene checkpoint-list",
		"scene checkpoint-restore",
		"scene collection",
		"scene hierarchy",
		"scene info",
		"scene job-cancel",
