...
but do not stop the import.`,
  ...
  mcp-blender-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  mcp-blender-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | mcp-blender-pp-cli import <resource> --input -`,
