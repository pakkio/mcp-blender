...
import (
	...
	"mcp-blender-pp-cli/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"mcp-blender-pp-cli auth login",
		"mcp-blender-pp-cli doctor",
		"mcp-blender-pp-cli help items",
		"mcp-blender-pp-cli sync",
		"mcp-blender-pp-cli profile list",
		"mcp-blender-pp-cli feedback list",
		"mcp-blender-pp-cli which",
		"mcp-blender-pp-cli agent-context",
		"mcp-blender-pp-cli completion bash",
		"mcp-blender-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"mcp-blender-pp-cli recall",
		"mcp-blender-pp-cli learnings",
		"mcp-blender-pp-cli teach-pattern",
		"mcp-blender-pp-cli teach-lookup",
		"mcp-blender-pp-cli items list",
	}
