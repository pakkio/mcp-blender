...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  mcp-blender-pp-cli which "stale tickets"
  mcp-blender-pp-cli which "bottleneck"
  mcp-blender-pp-cli which --limit 1 "send message"
  mcp-blender-pp-cli which                                # list the full capability index`,
