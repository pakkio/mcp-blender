...
| Capability | Generic Blender MCPs | `mcp-blender` (v2.2.1) |
| :--- | :--- | :--- |
...
### 32. Image-to-3D AI Generation (v2.1.3)
...
```bash
python scripts/build_extension.py              # packages dist/mcp_bridge-2.2.1.zip
```

3. In Blender 4.2+, open **Preferences > Get Extensions > Install from Disk...**,
   select `dist/mcp_bridge-2.2.1.zip`, and enable **MCP Bridge**.
