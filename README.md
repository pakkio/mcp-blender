...
| Capability | Generic Blender MCPs | `mcp-blender` (v2.3.0) |
| :--- | :--- | :--- |
...
```bash
python scripts/build_extension.py              # packages dist/mcp_bridge-2.3.0.zip
```

3. In Blender 4.2+, open **Preferences > Get Extensions > Install from Disk...**,
   select `dist/mcp_bridge-2.3.0.zip`, and enable **MCP Bridge**.
