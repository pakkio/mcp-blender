...
DOMAIN_DOCS: dict[str, dict[str, Any]] = {
    "blender_mesh": {
        ...
        "actions": {
            ...
            "decimate": "Reduce polygon/vertex count using COLLAPSE, UNSUBDIV, or PLANAR. Params: object_name, ratio (e.g. 0.1 for 10%), mode.",
            "remesh": "Voxel or Quad remesh geometry for clean manifold topology. Params: object_name, mode ('VOXEL'), voxel_size.",
